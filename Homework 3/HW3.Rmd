...
# For Males: It seems like the sender looks does matter because if the receiver is more than 2 levels
# higher than his max level, the prob of the message decrease. Nonetheless the probability is the 
# same for the whole sample for the lowest levels

# For Females: It seems that the probability of sending a message increases if the receiver has
# up to two more levels. On the other hand, as males, if the receiver looks is more than two
# levels higher than the sender, the proability decreases.
...
base.level <- 1
plot(x=1:11,y=pred.match(base.level,1:11),type='b',pch=19,col="steelblue",xlab="Receiver Looks",ylab="Predicted Probability")
lines(x=1:11,y=pred.match(1:11,base.level),type='b',pch=19,col='blue',lty=2)
...
# They differ because it is more important for the male sender the receiver look, so there is no
# simmetry for the results. 
pred.match(2,10)
pred.match(10,2)
