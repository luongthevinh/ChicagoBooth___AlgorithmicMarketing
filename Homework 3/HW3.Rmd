...
par(mfrow=c(2,2))
for(i in 1:4){
  plot(A[i,1:11],xlab='Receiver Looks', ylab='Match Score',col='blue',type='l', main=paste("Match Score For Sender Look Rating ", i))
  lines(A[1:11,i],col='red', type='l')
  legend(2,A[i,11],col=c('blue','red'), lty=1,c('Male Sender','Female Sender'))
}
